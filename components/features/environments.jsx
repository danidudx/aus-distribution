  ...
  return (
    <div className="bg-[#fffae7] xl:h-[670px] h-auto pb-20 xl:p-20">
      <div className="flex flex-col w-[90%] mx-auto ">
        ...
        <div className="xl:flex lg:grid lg:grid-cols-2 justify-center xl:gap-16 2xl:gap-48 gap-4 mt-10 xl:flex-row flex-col">
          {features.map((feature, index) => (
            <div
              key={index}
              className="flex flex-col items-center xl:gap-4 mx-16 xl:mx-10"
            >
              <div className="flex items-center justify-center mb-4 border-[#FF3366] bg-clip-border text-[#FF3366]">
                <Image src={feature.icon} alt="icon" width={80} height={80} />
              </div>
              <p
                className="text-[#0B2F3D] xl:text-3xl text-2xl font-semibold font-[Tropiline] text-center leading-[150%]"
